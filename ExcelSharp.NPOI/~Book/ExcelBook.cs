    ...
    public partial class ExcelBook
    {
        ...
        public string MediaType
        {
            get
            {
                switch (Version)
                {
                    case ExcelVersion.Excel2003: return "application/vnd.ms-excel";
                    case ExcelVersion.Excel2007: return "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
        ...
        public CStyle CStyle(CStyleApplier applier)
        {
            ...
            if (find is null)
                return new CStyle(this).Then(x => applier.Apply(x));
            else return find;
        }
        ...
        internal CFont CFont(CFontApplier applier)
        {
            ...
            if (find is null)
                return new CFont(this).Then(x => applier.Apply(x));
            else return find;
        }
